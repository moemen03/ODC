...
import '../../../view model/bloc/FAQ/faq_cubit.dart';
            ...
            child: BlocConsumer<FaqCubit, FaqState>(
                ...
                builder: (context, state) {
                  ...
                  return Container(
                    ...
                    child: cub.dataModel == null ? Center(child: CircularProgressIndicator(
                      color: Colors.deepOrange,
                    ))
                        :ListView.builder(
                      physics: BouncingScrollPhysics(),
                      itemCount: cub.dataModel!.data!.length,
                          ...
                          children: [
                                      ...
                                      children: [
                                        Expanded(
                                          child: RichText(text: HTML.toTextSpan(
                                              context,
                                              cub.dataModel!.data![index].question.toString(),
                            ...
                            AnimatedContainer(
                              ...
                              child: Center(
                                child: RichText(text: HTML.toTextSpan(
                                    context,
                                    cub.dataModel!.data![index].answer.toString(),
                                    defaultTextStyle: TextStyle(color: Colors.white),
                                    overrideStyle: <String, TextStyle>{
                                      'p': const TextStyle(
                                          fontSize: 20),
